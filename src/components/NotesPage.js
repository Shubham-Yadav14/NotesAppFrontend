  ...
  return (
    <div className={`flex ${darkMode ? "bg-black" : ""}`}>
      ...
      <div className={`w-full ${darkMode ? "bg-[#1E1E1E]" : "bg-gray-100"}`}>
        <Narrow>
          <div className="flex max-md:flex-col-reverse max-md:gap-3 justify-between mb-5 mt-10">
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg flex w-[50vw] h-[50vh]">
            <div className="w-1/2 p-1">
              ...
              <div className={`${currentNote?.color || noteToEdit.color} border p-4 rounded-lg h-[90%] overflow-auto`}>
