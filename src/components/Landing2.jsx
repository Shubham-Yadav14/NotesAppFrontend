  ...
  return (
    <>
      ...
      <div className="bg-[#1E1E1E] pt-10 overflow-hidden">
        <Narrow>
          <div className="py-40">
            <div className="text-6xl text-center text-white mb-10">
              Members Directory
            </div>
            <div className="grid grid-cols-3  gap-10 max-md:grid-cols-2 max-sm:grid-cols-1 max-sm:p-20">
              <div className="bg-[#FFD966] flex p-10 max-xl:px-4 max-lg:flex-col max-lg:items-center">
                <div className="bg-white p-3 w-full">
                  {" "}
                  <img
                    src="https://ik.imagekit.io/ouhkc1hsep/New%20Folder/Dum-Aloo2.jpg?updatedAt=1722985078910"
                    alt=""
                  />
                </div>
                <div className=" ml-10 w-6/12 max-xl:ml-3">
                  <div>Drishti Aggarwal</div>
                  <div className="text-sm text-wrap">email@gmail.com</div>
              ...
              <div className="bg-[#FFAFA3] flex p-10  max-xl:px-4 max-lg:flex-col max-lg:items-center">
                ...
                <div className=" ml-10 w-6/12 max-xl:ml-5">
                  <div>Madhav Nakra</div>
                  <div className="text-sm text-wrap">email@gmail.com</div>
                  <div className="flex gap-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="bg-[#85E0A3] flex p-10  max-xl:px-4 max-lg:flex-col max-lg:items-center">
                <div className="bg-white p-3 w-5/12"> <img src="https://ik.imagekit.io/ouhkc1hsep/New%20Folder/Yadav2.jpg?updatedAt=1722984971272" alt="" /></div>
                <div className=" ml-10 w-6/12 max-xl:ml-5">
        ...
        <div className="mt-72 text-6xl relative -top-20 text-[#FFFFFF] opacity-70 text-center scale-[750%] font-semibold max-2xl:scale-[700%] max-xl:scale-[600%] max-lg:scale-[490%] max-md:scale-[375%] max-sm:scale-[250%] ">
          noteify
        </div>
      </div>
    </>
