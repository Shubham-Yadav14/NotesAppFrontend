    ...
    <div>
        ...
        <div id="shinchan" className=' h-[87vh]'>
            <div className=' flex flex-col items-center text-center text-white h-[80%]'>
               ...
               <button className=' text-black text-3xl inline-flex items-center whitespace-nowrap select-none justify-center bg-white font-normal gap-2 rounded-3xl px-5 md:px-7 py-2 md:py-3' onClick={(e) => loginWithRedirect()}>Start from here</button>
               </div>
            </div>
        </div>
