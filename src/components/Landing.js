    ...
    <div>
        ...
        <div id="shinchan" className=' h-[87vh] max-md:h-[80vh]'>
            <div className=' flex flex-col items-center text-center text-white h-[80%]'>
               ...
               <button className=' text-black text-3xl inline-flex items-center whitespace-nowrap select-none justify-center bg-white font-normal gap-2 rounded-full px-5 md:px-7 py-2 max-md:py-3 max-md:px-5' onClick={(e) => loginWithRedirect()}>Start from here</button>
               </div>
            </div>
        </div>
